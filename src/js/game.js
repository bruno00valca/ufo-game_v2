(function (global) {
    const Game = {
        ...
        init(prefs, elements = {}) {
            ...
            this.onGameEnd = elements.onGameEnd || null;
        },
        ...
        _createScoreAndMissile() {
            ...
            m.src = "assets/images/missile.png";
            m.className = "missile";
        ...
        _endGame() {
            ...
            if (this.onGameEnd) {
                this.onGameEnd({
                    ...
                    ufos: Number(this.prefs.numUfos),
                    disposedTime: Number(this.prefs.gameTime),
                });
            }
